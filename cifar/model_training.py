...
class trainModel():
    ...
    def __init__(self, model,
        ...
        if(optimizer == 'Adam'):
            ...
            self.optimizer = get_sgd_optimizer(model)
        # self.loss_criterion = 'CE'
    ...
    def show_best_model(self):
        ...
        test_loss, test_accuracy = self.test(self.model, self.device, self.test_loader, self.loss_function )
